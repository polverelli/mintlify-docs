...
<CardGroup cols={3}>
  <Card title="Add Funds" icon="money-bill-transfer" href="/api-reference/transactions/on-ramp">
    Convert fiat to stablecoins
  </Card>
  <Card title="Make Transfers" icon="arrows-rotate" href="/api-reference/transactions/transfer">
    Send funds between customers
  </Card>
  <Card title="Withdraw Funds" icon="bank" href="/api-reference/transactions/off-ramp">
